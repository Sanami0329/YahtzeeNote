<div class="text-zinc-900">
    ...
    <section class="relative !h-screen flex items-center justify-center text-white mt-6 overflow-hidden">
        ...
        <div class="lg:!w-4/5 lg:!h-3/4 xl:!px-20 lg:!pt-10 mx-auto felx items-center bg-white/40 backdrop-blur-sm text-center">
            <div class="mx-auto my-20 py-6 flex flex-col w-3xl">
                <h1 class="mx-auto !text-4xl lg:!text-5xl font-bold text-zinc-900 text-shadow">
                    YahtzeeNote
                </h1>
                <p class="mx-auto my-4 !text-sm lg:!text-lg px-8 text-shadow text-zinc-900 font-semibold">
                    Yahtzee（ヤッツィー）のスコアを<br class="sm:hidden">紙要らずで素早く入力、自動計算。<br>
                    プレイ履歴やいつものメンバーもまとめて管理。
                </p>
                @auth
                <flux:link
                    class="mx-auto my-4 px-4 lg:text-xl text-zinc-700 mb-8"
    ...
    <section id="practice-areas" class="p-4 lg:px-16 pt-6 pb-10 bg-brand-yellow-200">
        ...
        <div class="container mx-auto text-center">
            ...
            <flux:button
                variant="primary"
                icon="play"
                class="lg:mt-10 lg:w-32 lg:!h-12 text-center !border !bg-white !text-zinc-600 hover:!bg-brand-yellow-600 !font-semibold hover:!font-bold"
